...
namespace NCoreUtils.Text
{
    ...
    {
        /// <summary>
        /// Camel case names adds no additional characters thus maximum result character count is less than or equals to
        /// the source character count.
        /// </summary>
        /// <param name="sourceCharCount">Source character count.</param>
        /// <returns>
        /// Maximum number of characters needed to store input of the specified length as camel case string.
        /// </returns>
        public int GetMaxCharCount(int sourceCharCount)
            => sourceCharCount;

        /// <summary>
        /// Attempts to convert name specified in <paramref name="source" /> to camel case naming convention. On success

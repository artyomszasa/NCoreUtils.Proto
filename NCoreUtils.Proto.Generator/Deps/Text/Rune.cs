// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
// USED ONLY TO PROVIDE VALID FUNCTIONALITY FOR PRE-NETCORE3 RUNTIME VERSIONS
// source: https://github.com/dotnet/runtime/blob/90cc6dff11e4eea07d8b2ed438b25679f0caf7a8/src/libraries/System.Private.CoreLib/src/System/Text/Rune.cs
// !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
namespace NCoreUtils.Text
{
    ...
    public readonly struct Rune : IComparable<Rune>, IEquatable<Rune>
    {
        ...
        // non-validating ctor
        [SuppressMessage("Style", "IDE0060", MessageId = "unused")]
        ...
        public static OperationStatus DecodeLastFromUtf8(ReadOnlySpan<byte> source, out Rune value, out int bytesConsumed)
        {
            ...
            if ((uint)index < (uint)source.Length)
            {
                ...
                if (((byte)tempValue & 0x40) != 0)
                {
                    ...
                    return DecodeFromUtf8(source[index..], out value, out bytesConsumed);
                }
        ...
        public static Rune GetRuneAt(string input, int index)
        {
            ...
            if (runeValue < 0)
            {
                throw new ArgumentException("Can not extract scalar.", nameof(index));
            }

...
public class ProtoClientSyntaxReceiver : ISyntaxContextReceiver
{
    ...
    internal List<ProtoClientMatch>? Matches { get; set; }
        ...
        if (context.Node is ClassDeclarationSyntax cds)
        {
            ...
            foreach (var attribute in attributes)
            {
                ...
                if (fullName == "ProtoClientAttribute" || fullName == "NCoreUtils.Proto.ProtoClientAttribute")
                {
                    ...
                    target = new ProtoClientMatchBuilder(context.SemanticModel, cds);
